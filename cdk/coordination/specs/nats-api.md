...
| Subscribe | `{owner_space}.forApp.>`, `{owner_space}.eventTypes` |
...
| Permission | Topics |
|------------|--------|
| Publish | `{owner_space}.forApp.>`, `{message_space}.forOwner.>`, `{message_space}.ownerProfile` |
| Subscribe | `{owner_space}.forVault.>`, `{owner_space}.control`, `{owner_space}.eventTypes`, `{message_space}.forOwner.>` |
