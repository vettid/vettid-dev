...
const EXPECTED_ENDPOINT = '/api/v1/vault/stop';
 ...
 *
 * Stop a running vault EC2 instance using action token authentication.
...
export const handler = async (event: APIGatewayProxyEventV2): Promise<APIGatewayProxyResultV2> => {
  ...
  try {
    ...
    console.error('Stop vault action error:', error);
